    ...
    public class ReorderableList
    {
        ...
        static class Style
        {
            ...
            static Style()
            {
                ...
                // Usar ícones compatíveis - tentar ícones modernos primeiro, com fallback
                GUIContent expandIcon = EditorGUIUtility.IconContent("TreeEditor.ArrowRight");
                if (expandIcon == null || expandIcon.image == null)
                    expandIcon = EditorGUIUtility.IconContent("TreeEditor.ArrowDown");
                if (expandIcon == null || expandIcon.image == null)
                    expandIcon = new GUIContent("▼");
                expandButton = expandIcon;

                GUIContent collapseIcon = EditorGUIUtility.IconContent("TreeEditor.ArrowDown");
                if (collapseIcon == null || collapseIcon.image == null)
                    collapseIcon = EditorGUIUtility.IconContent("TreeEditor.ArrowRight");
                if (collapseIcon == null || collapseIcon.image == null)
                    collapseIcon = new GUIContent("▶");
